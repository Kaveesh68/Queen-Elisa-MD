...
global.author = 'Ƙίηɡ Ƙαѵίψα ɓσt' // Sticker Autor name 
global.sessionName = 'session'
global.prefa = ['#','!','/',''] 
global.sp = '🔵'
// Alive massage , ඔබේ බොගේ alive massage  එක මෙහි ඇති `ΝᎪᎷᎬ:  
...
𝙎𝙚𝙧𝙫𝙞𝙘𝙚𝙨 𝙮𝙤𝙪 𝙘𝙖𝙣 𝙜𝙚𝙩 𝙛𝙧𝙤𝙢 𝙌𝙪𝙚𝙚𝙣 𝙀𝙡𝙞𝙨𝙖 𝙈𝘿
...
*ͲᎻᎪΝᏦ ᎽϴႮ ҒϴᎡ ႮՏᏆΝᏀ 𝙌𝙪𝙚𝙚𝙣 𝙀𝙡𝙞𝙨𝙖 𝙈𝘿

☺️ ` මෙම ලකුනු ඇතුලේ ඔබට අවශ්‍ය ඔනිම දෙයක් Type කරන්න.💃
